...
internal sealed class ChargeHoleCommandHandler(IEventStore eventStore, IBlastProjection projection)
{
    public async Task HandleAsync(ChargeHoleCommand command, CancellationToken cancellationToken)
    {
